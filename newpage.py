...
""", unsafe_allow_html=True)
    ...
    if df is not None:
        ...
        with col1:
            st.markdown(f'''<div style="text-align: center; padding: 15px; background-color: #FEF2F2; border-radius: 10px; border-left: 4px solid #EF4444;"><div style="font-size: 12px; color: #6B7280;">Low Engagement</div><div style="font-size: 24px; font-weight: 700; color: #EF4444;">{low_pct}%</div></div>''', unsafe_allow_html=True)
        with col2:
            st.markdown(f'''<div style="text-align: center; padding: 15px; background-color: #FFFBEB; border-radius: 10px; border-left: 4px solid #FBBF24;"><div style="font-size: 12px; color: #6B7280;">Medium Engagement</div><div style="font-size: 24px; font-weight: 700; color: #FBBF24;">{medium_pct}%</div></div>''', unsafe_allow_html=True)
        with col3:
            st.markdown(f'''<div style="text-align: center; padding: 15px; background-color: #ECFDF5; border-radius: 10px; border-left: 4px solid #10B981;"><div style="font-size: 12px; color: #6B7280;">High Engagement</div><div style="font-size: 24px; font-weight: 700; color: #10B981;">{high_pct}%</div></div>''', unsafe_allow_html=True)
